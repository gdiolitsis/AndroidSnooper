...
class DatabaseReaderTest {
    ...
    private lateinit var dbReaderCallback:
            DbReaderCallback

    private lateinit var databaseDataReader:
            DatabaseDataReader
    ...
    private fun isSameAsDatabaseWithParameters(
        path: String,
        name: String
    ): Matcher<Database> {
