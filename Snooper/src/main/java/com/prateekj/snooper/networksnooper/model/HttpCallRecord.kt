    ...
    companion object {
        ...
        fun from(
            ...
            return HttpCallRecord(
                url = httpCall.url,
                payload = httpCall.payload,
                method = httpCall.method,
                responseBody = httpCall.responseBody,
                statusText = httpCall.statusText,
                statusCode = httpCall.statusCode,
                date = httpCall.date,
                error = httpCall.error,
                requestHeaders = HttpHeader.from(
                    httpCall.requestHeaders
                ),
                responseHeaders = HttpHeader.from(
