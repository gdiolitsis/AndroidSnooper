...
class ViewMatcherIdlingResource(
    ...
    override fun isIdleNow(): Boolean {
        ...
        val timeExceeded =
            now() - startTime >= waitTimeInMillis
    ...
    override fun registerIdleTransitionCallback(
        ...
        pollViewUntilMatchesOrTimeout(
            resourceCallback
        )
    }

    private fun pollViewUntilMatchesOrTimeout(
        resourceCallback: IdlingResource.ResourceCallback
    ) {
            ...
            Thread {
                ...
                while (
                    ...
                    try {
                        ...
                        Logger.d(
                            TAG,
                            "polling view to match $viewMatcher"
                        )

                        Thread.sleep(
                            MATCHER_POLLING_INTERVAL_IN_MILLIS.toLong()
                        )
    ...
    companion object {
        ...
        private const val MATCHER_POLLING_INTERVAL_IN_MILLIS =
            100

        val TAG =
            ViewMatcherIdlingResource::class.java.simpleName
    }
}
