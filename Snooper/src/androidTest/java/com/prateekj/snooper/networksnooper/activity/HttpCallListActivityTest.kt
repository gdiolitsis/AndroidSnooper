...
class HttpCallListActivityTest {
    ...
    fun shouldRenderHttpCalls() {
        ...
        onView(
            withText(
                R.string.title_activity_http_call_list
            )
        ).check(
            matches(
                isDisplayed()
    ...
    private fun verifyClickActionOnListItem(
        itemIndex: Int,
        httpCallId: Long
    ) {
        ...
        intended(
            ...
            allOf(
                ...
                hasComponent(
                    HttpCallActivity::class.java.name
                ),

                hasExtra(
                    HttpCallActivity.HTTP_CALL_ID,
                    httpCallId
                )
            )
        )
