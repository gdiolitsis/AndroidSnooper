...
class HttpCallActivityTest {
    ...
    fun shouldRenderRequestAndResponseBody() {
        ...
        val requestPayload =
            readFrom(
                "person_details_raw_request.json"
            )
        ...
        onView(
            withText(
                R.string.title_http_call_activity
            )
        ).check(
            matches(
                isDisplayed()
        ...
        onView(
            ...
            matches(
                withText(
                    readFrom(
                        "person_details_formatted_request.json"
                    )
                )
            )
        )
    ...
    private fun withHeaderData(
        ...
        return object :
            CustomTypeSafeMatcher<HttpHeaderViewModel>(
                "Header matcher"
            ) {

            override fun matchesSafely(
                viewModel: HttpHeaderViewModel
            ): Boolean {

                return viewModel.headerName() == headerName &&
                        viewModel.headerValues() == headerValue
            }
        }
    }
        ...
        intended(
            ...
            allOf(
                ...
                hasExtras(
                    ...
                    EspressoIntentMatchers
                        .forMailChooserIntent(
                            ACTION_SEND,
                            "*/*",
                            "Log details",
